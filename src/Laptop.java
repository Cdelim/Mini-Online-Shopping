...
public class Laptop extends Computer {
	 ...
	 * @param HDMISupport	Indicates whether the object is an HDMI support.
	 */
	public Laptop(String type, String price, String manufacturer, String brand, String maxVolt, String maxWatt,
		...
		if(HDMISupport.equals("0")){
			this.HDMISupport="No";
		}
		else if(HDMISupport.equals("0")){
